        ...
        <div className="main_container grid grid-cols-1 md:grid-cols-3">
          <div className="pt-6 pb-6 md:pl-6 md:col-span-2 pl-0 ">
            <div className="bg-white rounded p-0 md:pl-16 md:pt-16 md:pb-16 md:pr-0 md:pr-16 ">
              <div className="p-4 ">
                <h1 className="text-4xl font-semibold letter-space-2">
                  Get In Touch
                </h1>
                <div className="grid grid-cols-1 my-2 md:grid-cols-2 gap-4">
                  <input
                    ...
                    name="name"
                    onBlur={handleBlur}
                    className="p-2 rounded border border_custom_shadow"
                    placeholder="Name"
                    required
                  />
                  <input
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  name="subject"
                  className="p-2 rounded w-full my-2 border border_custom_shadow"
                  placeholder="Subject"
                  required
                />
                <textarea
                  name="message"
                  onBlur={handleBlur}
                  className="p-4 h-42 md:h-52 lg:h-42 my-2 rounded w-full border border_custom_shadow"
                  placeholder="Message"
                ></textarea>
                <button
                  onClick={handleSubmit}
                  className="p-2 rounded flex items-center justify-center bg-pink-500 my-2 text-white border_custom_shadow"
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="bg-pink-500 p-4 md:p-10 rounded text-white">
